...
<section class="panel">
    ...
    <p id="inventory-banner" class="banner" style="display:none" role="status" aria-live="polite"></p>
    <div id="inventory-actions" class="form-grid">
        ...
        <form id="inventory-reserve-form" class="form-grid">
            ...
            <label>Event ID <input name="event_id" type="text" placeholder="cleaning-event-uuid" required></label>
            <label>Location
...
<section class="panel">
    ...
    <div class="form-grid">
        <label>Event ID <input id="av-event-id" type="text" placeholder="cleaning-event-uuid"></label>
        <label>Location
